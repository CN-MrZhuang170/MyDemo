...
<body onkeypress="findCity_enter()">
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="" style="width: 80%;float:left;">
            <!-- 聊天区 -->
            <div class="am-scrollable-vertical" id="chat-view" style="height: 370px;">
            ...
            <div class="am-form-group am-form" >
                <form name="yan" >
                <textarea class="" id="message" name="ren" rows="6"  cols="35" onKeyDown ="backhome"  placeholder="这里输入你想发送的信息..."></textarea>
                </form>
            </div>
            <!-- 接收者 -->
            ...
            <div class="am-btn-group am-btn-group-xs" style="float:right;">
                ...
                <button class="am-btn am-btn-default" type="button" id="find" onclick="sendMessage()"><span class="am-icon-commenting"></span> 发送</button>
